  ...
  const renderPage = () => {
    const pageComponent = (() => {
      switch(currentPage) {
        ...
        case 4: return <EmployeeList onNavigate={setCurrentPage} />;
        case 5: return <EmployeeForm onNavigate={setCurrentPage} />;
        case 6: return <Dashboard onNavigate={setCurrentPage} />;
        ...
        case 17: return <AircraftForm onNavigate={setCurrentPage} />
